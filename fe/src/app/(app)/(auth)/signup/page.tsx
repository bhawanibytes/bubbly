    ...
    return (
        <>
            <div className="flex min-h-[91dvh] flex-col">
                {/* <div className="md:max-w-[70%] mx-auto outline outline-gray-400 flex w-full justify-center gap-50">
          <div
          ...
          >
            2
                ...
                <div className="mx-40 flex grow items-center justify-around gap-10">
