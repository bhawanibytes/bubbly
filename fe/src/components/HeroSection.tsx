...
export default function HeroSection() {
    return (
        <>
            <div className="relative z-0 m-4 h-120 w-232">
                <div
                    style={{
                        backgroundImage: `linear-gradient(rgba(0,0,0,0.1), rgba(0,0,0,0.4)), url('/heroImage.png')`,
                    }}
                    className="hero-image flex min-h-120 min-w-232 flex-col justify-end gap-8 rounded-2xl bg-[url('/heroImage.png')] bg-cover bg-center bg-no-repeat px-10 pb-10 text-white"
                >
