        ...
        <div className="navContainer flex min-h-16 items-center justify-between text-black">
            ...
            <nav className="navlinks flex items-center gap-8">
                ...
                <div className="flex gap-2 font-bold">
                    <Link
                        href="/signup"
                        className="flex h-10 w-21.5 items-center justify-center rounded-3xl bg-black text-sm text-white"
                    >
                        Sign Up
                    </Link>
                    <Link
                        href="/login"
                        className="flex h-10 w-21.5 items-center justify-center rounded-3xl bg-[#F2F2F2] text-sm"
                    >
                        Log in
                    </Link>
                </div>
